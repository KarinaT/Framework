...
public class WashingMachinesTest extends TestBase {
	...
	public void testFilterPrice(String categoryName, String productType, double minPrice, double maxPrice) throws Exception {
		System.out.println("==============testFilterPrice("+categoryName+", "+productType+")==============");
		goToMainPage();
